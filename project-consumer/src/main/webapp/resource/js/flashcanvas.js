    ...
    function G() {
        ...
        if (a === "width" || a === "height") {
            var b = event.srcElement,
				c = b[a],
				d = parseInt(c, 10);
            if (isNaN(d) || d < 0) d = a === "width" ? 360 : 180;
    ...
    m.prototype = {
        ...
        n: function () {
            if (this.A !== this.strokeStyle) {
                ...
                if (typeof a !== "string") if (a instanceof k || a instanceof v) a = a.id;
                else return;
        ...
        createPattern: function (a, b) {
            ...
            var c = a.tagName,
				d, f = this.d;
            if (c) if (c = c.toLowerCase(), c === "img") d = a.getAttribute("src", 2);
        ...
        drawImage: function (a, b, c, d, f, g, i, j, l) {
            a || h(17);
            var k = a.tagName,
				n, q = arguments.length,
				m = this.d;
            if (k) if (k = k.toLowerCase(), k === "img") n = a.getAttribute("src", 2);
            else if (k === r || k === "video") return;
            else h(17);
            else a.src ? n = a.src : h(17);
            this.b();
            this.c();
            n = t(n);
            if (q === 3) this.a.push(e.drawImage, q, n, b, c);
            else if (q === 5) this.a.push(e.drawImage, q, n, b, c, d, f);
            else if (q === 9) (d === 0 || f === 0) && h(1), this.a.push(e.drawImage, q, n, b, c, d, f, g, i, j, l);
            else return;
        ...
        loadImage: function (a, b, c) {
            var d = a.tagName,
				f, g = this.d;
            if (d) d.toLowerCase() === "img" && (f = a.getAttribute("src", 2));
            else if (a.src) f = a.src;
            if (f && !p[g][f]) {
                if (b || c) x[g][f] = [a, b, c];
